import{_ as n,o as s,c as a,e as t}from"./app-BcWTENpX.js";const p="/myblog/assets/new-BgIRENHm.png",o={},e=t(`<p>寄生组合继承</p><p>通过构造函数继承属性</p><p>通过原型链继承方法</p><pre><code class="language-js"><span class="token keyword">class</span> <span class="token class-name">Dog</span> <span class="token punctuation">{</span>
